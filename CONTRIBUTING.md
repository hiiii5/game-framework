...
1. Make an [Issue](https://github.com/dustin-roden/game-framework/issues/new)
...
```json
    {
        "dependencies": {
            "com.dustin-roden.game-framework": "https://github.com/YOUR_USER/game-framework.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at https://github.com/hiiii5/game-framework/issues.
